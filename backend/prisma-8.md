...
Your data contract is the heart of your application. It lives at [`src/lib/prisma/contract.prisma`](src/lib/prisma/contract.prisma) and describes your models:
...
| File | Purpose |
|---|---|
| [`src/lib/prisma/contract.prisma`](src/lib/prisma/contract.prisma) | Your data contract — define your models here |
...
1. Edit [`src/lib/prisma/contract.prisma`](src/lib/prisma/contract.prisma) to add or change models.
